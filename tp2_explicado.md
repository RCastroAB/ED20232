...
Dessa forma, ordenando os vértices pelas suas cores, você vai ter sempre *uma* ordenação que gera aquela coloração. Mas para garantir que seja a "canonica" (principalmente por motivos de avaliação automática por vpl), você também tem que garantir que os vértices ordenados por cor também estarão ordenados por rótulos quando suas cores forem iguais.
